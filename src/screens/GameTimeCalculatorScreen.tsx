  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.settingsCard}>
        <Text style={styles.cardLabel}>Match setup</Text>
...
const styles = StyleSheet.create({
  allocationGrid: { flexDirection: "row", flexWrap: "wrap", gap: 8 }, availabilityStrip: { alignItems: "center", backgroundColor: "#e7edcf", borderRadius: 18, flexDirection: "row", gap: 10, padding: 15 }, availabilityText: { color: "#375134", flex: 1, fontSize: 13, fontWeight: "700" }, availabilityValue: { color: "#18321f", fontSize: 28, fontWeight: "800" }, cardLabel: { color: "#5f6d59", fontSize: 11, fontWeight: "800", letterSpacing: 1.6, textTransform: "uppercase" }, cardLabelLight: { color: "#dce8b1", fontSize: 11, fontWeight: "800", letterSpacing: 1.6, textTransform: "uppercase" }, container: { gap: 22 }, fairnessBadge: { alignItems: "flex-end", gap: 2 }, fairnessLabel: { color: "#d0d9c3", fontSize: 11 }, fairnessValue: { color: "#ffffff", fontSize: 18, fontWeight: "800" }, noticeCard: { backgroundColor: "#f8f5ed", borderColor: "#ded7c8", borderRadius: 20, borderWidth: 1, gap: 4, padding: 18 }, noticeText: { color: "#626d60", fontSize: 14, lineHeight: 20 }, noticeTitle: { color: "#1a2a1e", fontSize: 16, fontWeight: "800" }, period: { borderBottomColor: "#ded7c8", borderBottomWidth: StyleSheet.hairlineWidth, flexDirection: "row", gap: 16, paddingVertical: 13 }, periodPlayers: { color: "#1a2a1e", flex: 1, fontSize: 14, fontWeight: "700", lineHeight: 20 }, periodTime: { color: "#6c7566", fontSize: 13, fontWeight: "700", width: 58 }, playerChip: { backgroundColor: "#e7edcf", borderRadius: 12, gap: 2, minWidth: "30%", paddingHorizontal: 12, paddingVertical: 10 }, playerMinutes: { color: "#18321f", fontSize: 16, fontWeight: "800" }, playerName: { color: "#5a6856", fontSize: 11, fontWeight: "700" }, resultCard: { backgroundColor: "#1c3825", borderRadius: 24, gap: 14, padding: 20 }, resultHeader: { alignItems: "flex-start", flexDirection: "row", justifyContent: "space-between" }, resultText: { color: "#dce4d5", fontSize: 14, lineHeight: 20, maxWidth: 310 }, schedule: { backgroundColor: "#f8f5ed", borderRadius: 18, paddingHorizontal: 16 }, section: { gap: 10 }, sectionHint: { color: "#626d60", fontSize: 14, lineHeight: 20 }, sectionTitle: { color: "#1a2a1e", fontSize: 19, fontWeight: "800", letterSpacing: -0.2 }, settingsCard: { backgroundColor: "#f8f5ed", borderColor: "#ded7c8", borderRadius: 24, borderWidth: 1, gap: 2, padding: 18 }, stepper: { alignItems: "center", borderBottomColor: "#ded7c8", borderBottomWidth: StyleSheet.hairlineWidth, flexDirection: "row", justifyContent: "space-between", paddingVertical: 14 }, stepperButton: { alignItems: "center", backgroundColor: "#e7edcf", borderRadius: 14, height: 36, justifyContent: "center", width: 36 }, stepperButtonText: { color: "#18321f", fontSize: 21, fontWeight: "700", lineHeight: 23 }, stepperControls: { alignItems: "center", flexDirection: "row", gap: 10 }, stepperLabel: { color: "#26352a", fontSize: 15, fontWeight: "700" }, stepperValue: { color: "#18321f", fontSize: 14, fontWeight: "800", minWidth: 54, textAlign: "center" }, target: { color: "#ffffff", fontSize: 34, fontWeight: "800", letterSpacing: -1 }, targetCaption: { color: "#d0d9c3", fontSize: 12, marginTop: -2 }, toggleCopy: { flex: 1, gap: 2 }, toggleHint: { color: "#687164", fontSize: 12, lineHeight: 17, maxWidth: 240 }, toggleRow: { alignItems: "center", flexDirection: "row", gap: 16, paddingTop: 14 }, toggleTitle: { color: "#26352a", fontSize: 15, fontWeight: "800" }
});
